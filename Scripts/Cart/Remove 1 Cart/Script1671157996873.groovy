...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Swag Labs/div_1'), '1')

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/button_Remove'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Swag Labs/a_Close Menu_shopping_cart_link'), '')
